...
from cf.user_based import UserBasedModel
...
class TinyTestCase(unittest.TestCase):
  ...
  def setUp(self):
    self.votes = [
        ...
        {'review': 'r1', 'reviewer': 'a1', 'voter': 'v4', 'vote': 5},
        {'review': 'r2', 'reviewer': 'a2', 'voter': 'v2', 'vote': 4},
        {'review': 'r2', 'reviewer': 'a2', 'voter': 'v3', 'vote': 4},
        {'review': 'r2', 'reviewer': 'a2', 'voter': 'v4', 'vote': 5},
        {'review': 'r3', 'reviewer': 'a3', 'voter': 'v1', 'vote': 5},
        {'review': 'r3', 'reviewer': 'a3', 'voter': 'v3', 'vote': 4},
        {'review': 'r3', 'reviewer': 'a3', 'voter': 'v4', 'vote': 5},
    ]
    self.test = [
        {'review': 'r1', 'reviewer': 'a1', 'voter': 'v3', 'vote': 3},
        {'review': 'r2', 'reviewer': 'a1', 'voter': 'v1', 'vote': 5},
        {'review': 'r3', 'reviewer': 'a3', 'voter': 'v2', 'vote': 1},
        {'review': 'r4', 'reviewer': 'a2', 'voter': 'v3', 'vote': 4},
        {'review': 'r1', 'reviewer': 'a1', 'voter': 'v5', 'vote': 4},
    ]
    self.pred = [
      # v3
